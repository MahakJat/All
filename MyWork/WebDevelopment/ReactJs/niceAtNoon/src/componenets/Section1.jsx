...
const Section1 = () => {
  return (
    <section className="flex pt-[5vh] justify-between px-[10vh] bg-[#E4E4E4]">
      <div className="leading-[0.9]  text-[17vh] font-medium tracking-tighter">
        <h1 className=" font-[font-1] leading-[0.9]">Turning heads</h1>
        <h1 className=" font-[font-1]"> and conquering</h1>
        <h1 className=" font-[font-1] flex items-center gap-6">
          hearts
          <span>
            <svg
      ...
      <div className="flex items-end justify-end w-1/3">
        <div>
          <p className="font-[font-2] font-thin leading-[1.2] text-[#262626]">
            NiceAtNoon is een boutique design <br />
            studio gespecialiseerd in branding en <br /> webdesign.
          </p>
          <button className="line-div-parent transition-all duration-600 flex ease-in-out px-[3vh] py-[1.5vh] bg-white rounded-[2vh] mt-6 hover:rounded-[6vh]  group">
            <h1>Bekijk projecten<div className="line-div h-[1px] w-[0%] bg-black"></div>
            </h1>
            <i className="ri-arrow-right-line bg-white ml-[2vh] transition-transform duration-300 group-hover:scale-125 inline-block"></i>
          </button>
        </div>
      </div>
    </section>
